  ...
  return (
    <div className="flex items-center space-x-3 px-4 h-full">
      ...
      <Select value={currentLanguage} onValueChange={handleLanguageChange}>
        <SelectTrigger className="w-auto min-w-[4rem] border-0 bg-transparent shadow-none focus:ring-0 focus:ring-offset-0 focus:outline-none focus-visible:ring-0 focus-visible:border-transparent hover:bg-white/30 transition-all duration-200 rounded-xl px-3 py-1.5 text-sm font-medium text-gray-700 hover:text-blue-700">
          <SelectValue />
        </SelectTrigger>
